...
```text
ghcr.io/sudheerkumarvatrapu/playsbc:1.3.0
ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:1.3.0
ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:1.3.0
ghcr.io/sudheerkumarvatrapu/playsbc-sipp:1.3.0
```

The standard process is:

1. Upgrade PlaySBC and RTPengine to `v1.3.0`.
