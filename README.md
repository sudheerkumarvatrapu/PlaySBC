...
PlaySBC v3.0.0 is the final public MIT baseline. Published source, images, and releases through v3.0.0 retain their MIT terms. The exact audited v3.0.0 tag will be imported into the access-controlled `SBC-Comm` repository. This boundary does not alter rights already granted for MIT code.
