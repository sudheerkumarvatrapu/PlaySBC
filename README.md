...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/-v1.3.1-111827?style=flat-square">
...
- Version: `1.3.1`
- License: MIT
- Release: <https://github.com/sudheerkumarvatrapu/PlaySBC/releases/tag/v1.3.1>
- Images: `ghcr.io/sudheerkumarvatrapu/playsbc:1.3.1`, `ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:1.3.1`, `ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:1.3.1`, `ghcr.io/sudheerkumarvatrapu/playsbc-sipp:1.3.1`
...
```text
ghcr.io/sudheerkumarvatrapu/playsbc:1.3.1
ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:1.3.1
ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:1.3.1
ghcr.io/sudheerkumarvatrapu/playsbc-sipp:1.3.1
```

The standard process is:

1. Upgrade PlaySBC and RTPengine to `v1.3.1`.
