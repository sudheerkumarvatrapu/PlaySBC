...
<p align="center">
  ...
  <img alt="Version" src="https://img.shields.io/badge/-v1.5.0-111827?style=flat-square">
...
- License: MIT
- Release: <https://github.com/sudheerkumarvatrapu/PlaySBC/releases/tag/v1.5.0>
- Images: `ghcr.io/sudheerkumarvatrapu/playsbc:1.5.0`, `ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:1.5.0`, `ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:1.5.0`, `ghcr.io/sudheerkumarvatrapu/playsbc-sipp:1.5.0`
...
```text
ghcr.io/sudheerkumarvatrapu/playsbc:1.5.0
ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:1.5.0
ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:1.5.0
ghcr.io/sudheerkumarvatrapu/playsbc-sipp:1.5.0
```

The standard process is:

1. Upgrade PlaySBC and RTPengine to `v1.5.0`.
