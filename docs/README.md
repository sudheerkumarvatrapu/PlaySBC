...
| Historical inherited AI/Rasa regression | [AI Voice Gateway](AI_VOICE_GATEWAY.md) | Compatibility |
| PlayFabric and PlayConverse integration | [PlayFabric and PlayConverse architecture](PLAYFABRIC_PLAYCONVERSE_ARCHITECTURE.md) | Kubernetes |
| Protocol transport, DNS, connection reuse, and TLS | [Protocol Core Layer 2](PROTOCOL_CORE_LAYER2.md) | Kubernetes |
| SIP transactions, timers, CANCEL, and retransmissions | [Protocol Core Layer 3](PROTOCOL_CORE_LAYER3.md) | Kubernetes |
| SIP dialogs, PRACK, session timers, UPDATE, forks, and HA fencing | [Protocol Core Layer 4](PROTOCOL_CORE_LAYER4.md) | Kubernetes |
| Registrar, routing, identity, and privacy policy | [Protocol Core Layer 5](PROTOCOL_CORE_LAYER5.md) | Kubernetes |
| Overload, security, recovery, and operations | [Protocol Core Layer 6](PROTOCOL_CORE_LAYER6.md) | Kubernetes |
