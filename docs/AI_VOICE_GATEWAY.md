...
- **Piper TTS:** generates the spoken bot reply WAV/RTP evidence.
- **SIPp:** caller traffic generator for voice profiles; chat profiles use YAML text cases.

## RASA Test Section

Use `--rasa-profiles` for the focused AI/Rasa suite. It runs **7 profiles** and writes:
...
- Add Whisper and Coqui alternatives beside Vosk/Piper.
- Stream longer bot responses.
