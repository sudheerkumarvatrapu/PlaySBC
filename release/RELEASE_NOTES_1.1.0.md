...
The Kubernetes regression runner was patched after the initial `v1.1.0` release to make 60 second CHT load profiles stable when run from published `v1.1.0` images.
