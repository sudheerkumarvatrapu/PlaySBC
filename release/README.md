...
- Version: `1.5.4`
- Helm chart package: `helm/playsbc-1.5.4.tgz`
- Project license: MIT
- Chart version: `1.5.4`
...
shasum -a 256 release/helm/playsbc-1.5.4.tgz > release/helm/playsbc-1.5.4.tgz.sha256
```
...
PYTHONPYCACHEPREFIX=/private/tmp/playsbc-pycache python3 tools/run_k8s_regression_job.py \
  --all-profiles \
  --runner-image ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:1.5.4 \
