...
- Version: `1.5.2`
- Helm chart package: `helm/playsbc-1.5.2.tgz`
- Project license: MIT
- Chart version: `1.5.2`
...
shasum -a 256 release/helm/playsbc-1.5.2.tgz > release/helm/playsbc-1.5.2.tgz.sha256
```
...
```bash
helm upgrade --install playsbc helm/playsbc-1.5.2.tgz \
  --namespace playsbc \
  --create-namespace \
...
This is the normal Kubernetes shape for `v1.5.2` and later:
