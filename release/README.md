# PlaySBC 1.1.0 Release Artifacts

This folder contains generated release artifacts for PlaySBC.

- Helm chart package: `helm/playsbc-1.1.0.tgz`
- Project license: MIT
- Chart version: `1.1.0`
...
```bash
helm upgrade --install playsbc helm/playsbc-1.1.0.tgz \
