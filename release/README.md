# PlaySBC 1.1.1 Release Artifacts

This folder contains generated release artifacts for PlaySBC.

- Helm chart package: `helm/playsbc-1.1.1.tgz`
- Project license: MIT
- Chart version: `1.1.1`
...
```bash
helm upgrade --install playsbc helm/playsbc-1.1.1.tgz \
...
PYTHONPYCACHEPREFIX=/private/tmp/playsbc-pycache python3 tools/run_k8s_regression_job.py \
  --all-profiles \
  --runner-image ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:1.1.1 \
  --sipp-image ghcr.io/sudheerkumarvatrapu/playsbc-sipp:1.1.1 \
  --playsbc-image ghcr.io/sudheerkumarvatrapu/playsbc:1.1.1 \
  --set-playsbc-image \
