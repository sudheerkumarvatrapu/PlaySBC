...
| --- | --- |
| Version | `4.0.0` |
| Chart | `helm/playsbc-4.0.0.tgz` |
| Checksum | `helm/playsbc-4.0.0.tgz.sha256` |
| Notes | `RELEASE_NOTES_4.0.0.md` |
| Product guide | `../output/pdf/PlaySBC-v4.0.0-Product-Guide.pdf` |
| License | MIT |

Published images:

```text
ghcr.io/sudheerkumarvatrapu/playsbc:4.0.0
ghcr.io/sudheerkumarvatrapu/playsbc-rtpengine:4.0.0
ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:4.0.0
ghcr.io/sudheerkumarvatrapu/playsbc-sipp:4.0.0
```
...
| Task | Runbook |
| --- | --- |
| Docker, kind, minikube, AKS, and real-device administration | [PlaySBC v4.0.0 Product Guide](../output/pdf/PlaySBC-v4.0.0-Product-Guide.pdf) |
...
shasum -a 256 release/helm/playsbc-4.0.0.tgz \
  > release/helm/playsbc-4.0.0.tgz.sha256
```
