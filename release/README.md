...
- Version: `1.5.1`
- Helm chart package: `helm/playsbc-1.5.1.tgz`
- Project license: MIT
- Chart version: `1.5.1`
...
shasum -a 256 release/helm/playsbc-1.5.1.tgz > release/helm/playsbc-1.5.1.tgz.sha256
```
...
```bash
helm upgrade --install playsbc helm/playsbc-1.5.1.tgz \
  --namespace playsbc \
  --create-namespace \
...
This is the normal Kubernetes shape for `v1.5.1` and later:
