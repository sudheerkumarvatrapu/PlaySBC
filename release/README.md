...
- Version: `1.4.0`
- Helm chart package: `helm/playsbc-1.4.0.tgz`
- Project license: MIT
- Chart version: `1.4.0`
...
shasum -a 256 release/helm/playsbc-1.4.0.tgz > release/helm/playsbc-1.4.0.tgz.sha256
```
...
```bash
helm upgrade --install playsbc helm/playsbc-1.4.0.tgz \
  --namespace playsbc \
  --create-namespace \
...
PYTHONPYCACHEPREFIX=/private/tmp/playsbc-pycache python3 tools/run_k8s_regression_job.py \
  --all-profiles \
  --runner-image ghcr.io/sudheerkumarvatrapu/playsbc-k8s-regression:1.4.0 \
  --sipp-image ghcr.io/sudheerkumarvatrapu/playsbc-sipp:1.4.0 \
  --playsbc-image ghcr.io/sudheerkumarvatrapu/playsbc:1.4.0 \
  --set-playsbc-image \
