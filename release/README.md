# PlaySBC 1.2.2 Release Artifacts

This folder contains generated release artifacts for PlaySBC.

- Helm chart package: `helm/playsbc-1.2.2.tgz`
- Project license: MIT
- Chart version: `1.2.2`
...
```bash
helm upgrade --install playsbc helm/playsbc-1.2.2.tgz \
