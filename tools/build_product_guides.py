...
PDF = ROOT / "output/pdf/PlaySBC-v4.0.0-Product-Guide.pdf"
HTML = ROOT / "output/html/PlaySBC-v4.0.0-Product-Guide.html"

if __name__ == "__main__":
    build_pdf(SOURCE, PDF, "4.0.0")
    build_html(SOURCE, HTML, "4.0.0")
    print(PDF)
    print(HTML)
